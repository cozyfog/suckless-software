...
static const char *browser[] = { "bash", "/home/nickel/.surf/start_surf", NULL };

static const char *volume_up[] = { "pw-volume", "change", "+2%", NULL };
static const char *volume_down[] = { "pw-volume", "change", "-2%", NULL };
static const char *volume_mute[] = { "pw-volume", "mute", NULL };
...
static const Key keys[] = {
    ...
    {0      ,     XF86XK_MonBrightnessDown,    spawn,          {.v = light_down}},
    { MODKEY,     XK_F7,     spawn,          {.v = volume_up   } },
    { MODKEY,     XK_F8,     spawn,          {.v = volume_down } },
